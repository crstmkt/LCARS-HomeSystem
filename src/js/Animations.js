...
export function showMainFrame() {
  var centerControls = $("#wpr_centerControls > .content *");

  let sequenceFramePattern = [];
...
export function raMainViewSetup() {
  ...
  $(mainRASequence).each(function () {
    ...
    $(this).addClass("alertFlash");
    posValMain = posValMain + 0.1;
  });
  timer_whiteFlash = setInterval(function () {
    $("body").toggleClass("alertFlash");
  }, posValMain * 1000);
}
