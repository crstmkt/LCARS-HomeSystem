...
LCARS.element.aside = function (oDef) {
  //Begin Required
  this.data = {
    type: "aside",
    id: oDef.id || "asideSID" + Math.random().toString(36).substr(2, 9),
  };
...
LCARS.element.aside.prototype = {
  //Required.  Create DOM element and base class
  create: function (oDef) {
    var element = $('<aside id="' + this.data.id + '"></aside>');
    return element;
  },
