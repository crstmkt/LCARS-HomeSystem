...
LCARS.element.footer = function (oDef) {
  //Begin Required
  this.data = {
    type: "footer",
    id: oDef.id || "footerSID" + Math.random().toString(36).substr(2, 9),
  };
...
LCARS.element.footer.prototype = {
  //Required.  Create DOM element and base class
  create: function (oDef) {
    var element = $('<footer id="' + this.data.id + '"></footer>');
    return element;
  },
