...
LCARS.element.sdk.defaultBracket = function (oDef) {
  ...
  this.data = {
    type: "defaultBracket",
    id:
      oDef.id || "defaultBracketSID" + Math.random().toString(36).substr(2, 9),
    namespace: "sdk",
  };
...
LCARS.element.sdk.defaultBracket.prototype = {
  ...
  create: function (oDef) {
    var element = $(
      '<div id="' + this.data.id + '" class="sdk default-bracket"></div>'
    );
    ...
    },
    {
      ...
      children: [
        { type: "bar", flexc: "v", color: "bg-" },
        {
          ...
          color: "bg-",
          children: [
            { type: "bar", class: { animated: true }, color: "bg-white" },
          ],
        },
        { type: "bar", flexc: "v", color: "bg-" },
      ],
