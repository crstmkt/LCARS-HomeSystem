...
LCARS.element.sdk.defaultBarFrame = function (oDef) {
  ...
  this.data = {
    ...
    id:
      oDef.id || "defaultBarFrameSID" + Math.random().toString(36).substr(2, 9),
    namespace: "sdk",
  };
...
LCARS.element.sdk.defaultBarFrame.prototype = {
  ...
  create: function (oDef) {
    var element = $(
      '<div id="' + this.data.id + '" class="sdk default-bar-frame"></div>'
    );
    ...
    this.elements.headerTitle =
      LCARS.active[this.elements.header.dom.find(".title").attr("id")];
    this.elements.headerControlsBefore =
      LCARS.active[
        this.elements.header.dom.find(".header-controls-before").attr("id")
      ];
    this.elements.headerControlsAfter =
      LCARS.active[
        this.elements.header.dom.find(".header-controls-after").attr("id")
      ];
    element.append(this.elements.header.dom);

    this.elements.content = LCARS.create({
      type: "wrapper",
      class: { content: true },
    });
    element.append(this.elements.content.dom);

    this.elements.footerTitle =
      LCARS.active[this.elements.footer.dom.find(".title").attr("id")];
    this.elements.footerControlsBefore =
      LCARS.active[
        this.elements.footer.dom.find(".footer-controls-before").attr("id")
      ];
    this.elements.footerControlsAfter =
      LCARS.active[
        this.elements.footer.dom.find(".footer-controls-after").attr("id")
      ];
  ...
  setting: {
    ...
    coloring: function (object, value) {
      var headerCapLeft =
        object.elements.header.dom.children(".cap:first-child");
      var headerCapRight =
        object.elements.header.dom.children(".cap:last-child");
      var headerBar = object.elements.header.dom.find(".bar");
      var headerTitle = object.elements.header.dom.find(".title");

      var footerCapLeft =
        object.elements.footer.dom.children(".cap:first-child");
      var footerCapRight =
        object.elements.footer.dom.children(".cap:last-child");
