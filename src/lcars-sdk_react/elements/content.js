...
// LCARS.element.content = function (oDef) {
//   //Begin Required
//   this.data = {
//     type: "content",
//     id: oDef.id || "contentSID" + Math.random().toString(36).substr(2, 9),
//   };
...
// LCARS.element.content.prototype = {
//   //Required.  Create DOM element and base class
//   create: function (oDef) {
//     var element = $('<div id="' + this.data.id + '" class="content"></div>');
//     return element;
//   },
