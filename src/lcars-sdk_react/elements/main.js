...
LCARS.element.main = function (oDef) {
  //Begin Required
  this.data = {
    type: "main",
    id: oDef.id || "mainSID" + Math.random().toString(36).substr(2, 9),
  };
...
LCARS.element.main.prototype = {
  //Required.  Create DOM element and base class
  create: function (oDef) {
    var element = $('<main id="' + this.data.id + '"></main>');
    return element;
  },
