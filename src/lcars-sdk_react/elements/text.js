...
LCARS.element.text = function (oDef) {
  //Begin Required
  this.data = {
    type: "text",
    id: oDef.id || "textSID" + Math.random().toString(36).substr(2, 9),
  };
