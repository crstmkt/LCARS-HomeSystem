...
LCARS.element.header = function (oDef) {
  //Begin Required
  this.data = {
    type: "header",
    id: oDef.id || "headerSID" + Math.random().toString(36).substr(2, 9),
  };
...
LCARS.element.header.prototype = {
  //Required.  Create DOM element and base class
  create: function (oDef) {
    var element = $('<header id="' + this.data.id + '"></header>');
    return element;
  },
