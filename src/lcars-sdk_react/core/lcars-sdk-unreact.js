...
import _wrapper from "../elements/wrapper";
...
export var LCARS = {
  ...
  element: {
    bar:
      ...
      function (oDef) {
        ...
        this.data = {
          type: "bar",
          id: oDef.id || "barSID" + Math.random().toString(36).substr(2, 9),
        };
        ...
        for (var prop in oDef) {
          if (typeof _bar.setting[prop] === "function") {
    ...
    block:
      ...
      function (oDef) {
        ...
        this.data = {
          type: "block",
          id: oDef.id || "blockSID" + Math.random().toString(36).substr(2, 9),
        };
        ...
        for (var prop in oDef) {
          if (typeof _block.setting[prop] === "function") {
            this.setting[prop](this, oDef[prop]);
          } else if (typeof LCARS.setting[prop] === "function") {
            LCARS.setting[prop](this, oDef[prop]);
          }
    ...
    button:
      ...
      function (oDef) {
        ...
        for (var prop in oDef) {
          if (typeof _button.setting[prop] === "function") {
            this.setting[prop](this, oDef[prop]);
          } else if (typeof LCARS.setting[prop] === "function") {
            LCARS.setting[prop](this, oDef[prop]);
          }
    ...
    elbow:
      ...
      function (oDef) {
        ...
        for (var prop in this.data) {
          if (typeof _elbow.setting[prop] === "function") {
    ...
    wrapper:
      ...
      function (oDef) {
        this.data = {
          type: "wrapper",
          id: oDef.id || "wrapperSID" + Math.random().toString(36).substr(2, 9),
        };
        ...
        for (var prop in oDef) {
          if (typeof _wrapper.setting[prop] === "function") {
            this.setting[prop](this, oDef[prop]);
          } else if (typeof LCARS.setting[prop] === "function") {
            LCARS.setting[prop](this, oDef[prop]);
          }
  ...
  setting: {
    ...
    color: function (object, sValue) {
      if (sValue === null) {
        ...
        if (object.data.type === "text" || object.data.type === "title") {
    ...
    click: function (object, value) {
      if (value !== null) {
        if (object.data.click) {
          object.dom.off("click");
        }
    ...
    mouseleave: function (object, value) {
      if (value !== null) {
        if (object.data.mouseleave) {
          object.dom.off("mouseleave");
        }
    ...
    mousedown: function (object, value) {
      if (value !== null) {
        if (object.data.mousedown) {
          object.dom.off("mousedown");
        }
    ...
    mouseup: function (object, value) {
      if (value !== null) {
        if (object.data.mouseup) {
          object.dom.off("mouseup");
        }
    ...
    mousemove: function (object, value) {
      if (value !== null) {
        if (object.data.mousemove) {
          object.dom.off("mousemove");
        }
    ...
    mouseout: function (object, value) {
      if (value !== null) {
        if (object.data.mouseout) {
          object.dom.off("mouseout");
        }
    ...
    mouseover: function (object, value) {
      if (value !== null) {
        if (object.data.mouseover) {
          object.dom.off("mouseover");
        }
    ...
    hover: function (object, value) {
      if (value !== null) {
        if (object.data.hover) {
          object.dom.off("hover");
        }
    ...
    tapstart: function (object, value) {
      if (value !== null) {
        if (object.data.tapstart) {
          object.dom.off("tapstart");
        }
    ...
    tapend: function (object, value) {
      if (value !== null) {
        if (object.data.tapend) {
          object.dom.off("tapend");
        }
    ...
    singletap: function (object, value) {
      if (value !== null) {
        if (object.data.singletap) {
          object.dom.off("singletap");
        }
    ...
    doubletap: function (object, value) {
      if (value !== null) {
        if (object.data.doubletap) {
          object.dom.off("doubletapevent");
        }
    ...
    taphold: function (object, value) {
      if (value !== null) {
        if (object.data.taphold) {
          object.dom.off("taphold");
        }
    ...
    swipe: function (object, value) {
      if (value !== null) {
        if (object.data.swipe) {
          object.dom.off("swipe");
        }
    ...
    swipeup: function (object, value) {
      if (value !== null) {
        if (object.data.swipeup) {
          object.dom.off("swipeup");
        }
    ...
    swiperight: function (object, value) {
      if (value !== null) {
        if (object.data.swiperight) {
          object.dom.off("swiperight");
        }
    ...
    swipedown: function (object, value) {
      if (value !== null) {
        if (object.data.swipedown) {
          object.dom.off("swipedown");
        }
    ...
    swipeleft: function (object, value) {
      if (value !== null) {
        if (object.data.swipeleft) {
          object.dom.off("swipeleft");
        }
    ...
    swipeend: function (object, value) {
      if (value !== null) {
        if (object.data.swipeend) {
          object.dom.off("swipeend");
        }
    ...
    scrollstart: function (object, value) {
      if (value !== null) {
        if (object.data.scrollstart) {
          object.dom.off("scrollstart");
        }
    ...
    scrollend: function (object, value) {
      if (value !== null) {
        if (object.data.scrollend) {
          object.dom.off("scrollend");
        }
    ...
    orientationchange: function (object, value) {
      if (value !== null) {
        if (object.data.orientationchange) {
          object.dom.off("orientationchange");
        }
    ...
    taphold2: function (object, value) {
      if (value !== null) {
        if (object.data.taphold2) {
          object.dom.off("taphold2");
        }
  ...
  helper: {
    ...
    viewportScale: function (object, oArgs) {
      ...
      if (
        oArgs.max !== true ||
        (oArgs.max === true && diffW < 1 && diffH < 1) ||
        (oArgs.max === true && diffW < 1) ||
        diffH < 1
      ) {
